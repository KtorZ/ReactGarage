...
Elm.Main.make = function (_elm) {
   ...
   var filtersToLi = F3(function (address,garage,filter) {
      ...
      _U.list([A2($Html.span,_U.list([]),_U.list([$Html.text(displayName)]))]));
   });
   var viewFiltering = F2(function (address,model) {
      return _U.list([A2($Html.div,
                     _U.list([$Html$Attributes.id("search_bar")]),
                     _U.list([A2($Html.div,
                     _U.list([$Html$Attributes.$class("search_bar")]),
                     _U.list([A2($Html.span,
                             _U.list([$Html$Attributes.$class("icon")]),
                             _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-search")]),_U.list([]))]))
                             ,A2($Html.input,
   ...
   var main = function () {
      ...
      return A2($Signal.map,view(actions.address),garage);
   }();
